				...
				<div class="ui-card-wrap">
						...
						<div class="col-lg-6 col-md-6">
							...
							<div class="card">
								<div class="card-main">
									...
									<p style="margin:0 auto;text-align:right;">
										...
										<p class="card-heading">每日签到可活动流量。
											<a target="_blank" href="http://www.kuaifaka.com/item/RBphH2.html"><img src="/buy3.png" 
												style="display:inline-block;float:right;margin-top:50px;margin-right:50px;width="60" height="60" alt=""/>
											</a>
							...
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										<p class="card-heading">帐号使用情况及连接信息</p>
										<dl class="dl-horizontal">
											<dt>用户名：{$user->user_name}      邮箱：{$user->email}     加入时间：{$user->regDate()}</dt>

											<dt>帐号等级：{$user->class}级</dt>
											

											<dt>等级过期时间：{$user->class_expire}</dt>
											

											<!--<dt>帐号过期时间：{$user->expire_in}</dt>--!>
											...
											<dt>连接端口:{$user->port}</dt>
											<dt>连接密码:{$user->passwd}</dt>
											<dt>加密方式：{$user->method}</dt>
											<dt>上次使用:{$user->lastSsTime()}</dt>
										</dl>
									</div>
								...
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										...
										<script type="text/javascript">
											...
											<dt style="text-align:center"><span style="font-size:14px;">总流量</span><code><span style="color: #FF9003;font-size:14px;">{$user->enableTraffic()}</span></code><span style="font-size:10px;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp已用流量</span><code><span style="color: #FF60AF;font-size:10px;">{$user->usedTraffic()}</span></code><span style="font-size:10px;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp剩余流量</span><code><span style="color: #FF60AF;font-size:10px;">{$user->unusedTraffic()}</span></code></dt>
									</div>
