...
<head>
	...
	<link href="/theme/material/css/alstarcss.css" rel="stylesheet">
	<link rel="stylesheet" href="/theme/material/css/helpcss.css">
		...
		<ul class="nav nav-list pull-left">
			<div>
				<a data-toggle="menu" href="#ui_menu">
					<span class="icon icon-lg text-white">storage</span>
	...
	<nav aria-hidden="true" class="menu menu-left nav-drawer nav-drawer-md" id="ui_menu" tabindex="-1">
		<div class="menu-scroll">
			<div class="menu-content">
				<a class="menu-logo" href="/index.php"><i class="icon icon-lg">person_pin_circle</i>&nbsp;用户面板</a>
				<ul class="nav">
					<li>
						<a class="waves-attach" data-toggle="collapse" href="#ui_menu_me"><span style="color:black" class="icon icon-lg text-white">looks_one</span>我的</a>
						<ul class="menu-collapse collapse in" id="ui_menu_me">
							<li>
								<a href="/user">
									<i class="icon icon-lg">home</i>&nbsp;首页
								</a>
							</li>
						...
						<a class="waves-attach" data-toggle="collapse" href="#ui_menu_use"><span style="color:black" class="icon icon-lg text-white">looks_two</span>使用</a>
						<ul class="menu-collapse collapse in" id="ui_menu_use">
							<li>
								<a style="color: #FF60AF" href="/user/node">
									<i class="icon icon-lg">router</i>&nbsp;<p>节点列表</p>
								</a>
							</li>
							
							<li>
								<a href="/user/help">
									<i class="icon icon-lg">help</i>&nbsp;使用教程
								</a>
							</li>
							...
							<li>
								<a href="/user/lookingglass">
									<i class="icon icon-lg">restore</i>&nbsp;观察窗口
								</a>
							</li>
						...
						<a class="waves-attach" data-toggle="collapse" href="#ui_menu_help"><span style="color:black" class="icon icon-lg text-white">looks_3</span>商城</a>
						<ul class="menu-collapse collapse in" id="ui_menu_help">
						
						
							<li>
								<a href="/user/shop">
									<i class="icon icon-lg">remove_shopping_cart</i>&nbsp;购买中心
								</a>
							</li>
							
							<li>
								<a href="/user/code">
									<i class="icon icon-lg">monetization_on</i>&nbsp;充值中心
								</a>
							</li>
							
							<li>
								<a style="color: #FF60AF" href="/user/payhelp">
									<i class="icon icon-lg">sentiment_very_satisfied</i>&nbsp;我要赞助
								</a>
							</li>
						...
						<a class="waves-attach" data-toggle="collapse" href="#ui_menu_beta"><span style="color:black" class="icon icon-lg text-white">looks_4</span>Beta</a>
						<ul class="menu-collapse collapse in" id="ui_menu_beta">
							<li>
								<a href="/user/beta/webconfig">
									<i class="icon icon-lg">bug_report</i>&nbsp;获取节点
								</a>
							</li>
						</ul>
