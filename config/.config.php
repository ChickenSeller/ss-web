...
//
// !!! 修改此key为随机字符串确保网站安全 !!!
$System_Config['key'] = '111111121213123';
$System_Config['debug'] =  'false';  //  正式环境请确保为false
$System_Config['appName'] = 'SSvip';             //站点名称
$System_Config['baseUrl'] = 'http://www.ssvip.ml';            // 站点地址
$System_Config['timeZone'] = 'PRC';        // RPC 天朝时间  UTC 格林时间
$System_Config['pwdMethod'] = 'sha256';       // 密码加密   可选 md5,sha256
$System_Config['salt'] = '000100';               // 密码加密用，从旧版升级请留空
...
// 用户签到设置
$System_Config['checkinMin'] = '66';       // 签到最少流量 单位MB
$System_Config['checkinMax'] = '666';       // 签到最多流量

//
$System_Config['defaultTraffic'] = '6';      // 用户初始流量 单位GB
...
$System_Config['db_host'] = '108.61.161.188';
$System_Config['db_database'] = 'ss';
$System_Config['db_username'] = 'ss';
$System_Config['db_password'] = '100200';
...
$System_Config['smtp_username'] = 'apikey';
$System_Config['smtp_port'] = '465';
$System_Config['smtp_name'] = 'apikey';
$System_Config['smtp_sender'] = 'alstar@sendgrid.net';
$System_Config['smtp_passsword'] = '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';
...
$System_Config['enable_duoshuo']='true';
...
#多说设置
$System_Config['duoshuo_shortname']="ssvip";
$System_Config['duoshuo_apptoken']="1be00cc710dcc66d11965be2d2c27ae7";
...
$System_Config['reg_auto_reset_bandwidth']='6';
...
$System_Config['auto_backup_email']='alstar@vip.qq.com';
$System_Config['auto_backup_webroot']='/home/wwwroot/alstar.ss/';
$System_Config['auto_backup_passwd']='100200';
...
#等级到期时重置为的流量值，GB
$System_Config['enable_class_expire_reset_traffic']='6';
...
#账户到期几天之后会删除账户
$System_Config['enable_account_expire_delete_days']='30';

#验证码相关设置，自己去 Geetest.com 申请
$System_Config['geetest_id']='40973863352fa5caaab0893a68bd33c5';
$System_Config['geetest_key']='1c830a95e3f1aba8bccbf14c6fe11779';
...
$System_Config['enable_auto_clean_uncheck_days']='31';


#自动清理多少天没使用的0级用户
$System_Config['enable_auto_clean_unused']='true';
$System_Config['enable_auto_clean_unused_days']='31';
