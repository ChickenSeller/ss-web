					...
					<div class="card">
						<div class="card-main">
							<div class="card-inner">
								...
								<p>请勿重复购买，重复购买流量不叠加。</p>
								<p>当前余额：{$user->money} 元。</p>
								<a href="/user/bought"><i class="icon icon-lg"></i>查看我的购买记录</a>
								...
								<div class="modal-footer">
									<p class="text-right"><button class="btn btn-flat btn-brand waves-attach" data-dismiss="modal" id="order_input" type="button">确定</button></p>
										...
										<p style="text-align:center;">									
											<a target="_blank" href="http://www.kuaifaka.com/item/RBphH2.html"><img src="/buy1.png" style="text-align:center;margin-top:50px;width="401" height="190" alt=""/></a>
										</p>
