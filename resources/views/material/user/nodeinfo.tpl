...
{include file='user/header_info.tpl'}
	...
	<main class="content">
		<div class="content-header ui-content-header">
			<div class="container">
				<h1 class="content-heading">节点详细信息</h1>
			</div>
		</div>
		<div class="container">
							...
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										<p class="card-heading">配置链接及帮助</p>
										<p class="card-inner margin-bottom-no"> <a href="http://ssvip.ml/help" target="_blank">不会使用点击这里。</a><br /></p>
										
						
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										{if $mu == 0}
										<p><a href="{$ssqr}"/>Android手机上用默认或主流的浏览器打开点我就可以直接添加到SSR中。</a></p>
										{/if}
