...
$app->get('/codeindex', 'App\Controllers\HomeController:codeindex');
...
$app->group('/user', function () {
	...
	$this->get('/help', 'App\Controllers\UserController:help');
	$this->get('/payhelp', 'App\Controllers\UserController:payhelp');
	...
	$this->get('/beta/webconfig','App\Controllers\UserController:showWebConfigBeta');
...
$app->group('/api', function () {
	...
	$this->post('/beta/{token}', 'App\Controllers\ApiController:serverGetUserNodeBeta');
});
